module github.com/operator-framework/audit
...
require (
	...
	github.com/operator-framework/api v0.11.2-0.20220124160859-73f2f9e7f359
	github.com/redhat-openshift-ecosystem/ocp-olm-catalog-validator v0.0.1
