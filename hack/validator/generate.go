...
func main() {
	...
	// Add here in the report the text of the validation that you would like to filter by
	validation := "invalid example"
	...
	for dir := range dirs {
		...
		dashboardPath := filepath.Join(fullReportsPath, dir, "validator")
